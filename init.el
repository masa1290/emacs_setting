...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (csv-mode restart-emacs minimap flycheck spaceline-all-the-icons spaceline smart-mode-line path-headerline-mode python-mode ox-hugo htmlize elpy undo-tree golden-ratio golden-ratio-scroll-screen neotree elscreen hiwin monokai-theme auto-complete))))
